...
import { PrivateMembershipsIncomeFilters } from 'src/app/models/reports.model';
import { PermissionsPipe } from 'src/app/pipes/permissions.pipe';
import { BrandService } from 'src/app/services/brand.service';
import { ReportsService } from 'src/app/services/reports.service';

@Component({
    selector: 'app-private-memberships-income-report-filters',
    templateUrl: './private-memberships-income-report-filters.component.html',
    styleUrl: './private-memberships-income-report-filters.component.scss',
...
export class PrivateMembershipsIncomeReportFiltersComponent implements OnInit {

  @Input() filters: PrivateMembershipsIncomeFilters;
  users: any[] = [];
  branches: any[] = [];
