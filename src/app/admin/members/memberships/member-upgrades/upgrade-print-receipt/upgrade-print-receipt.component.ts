...
import { IMembershipUpgrade } from 'src/app/models/member.model';
...
@Component({
    selector: 'app-upgrade-print-receipt',
    templateUrl: './upgrade-print-receipt.component.html',
    styleUrls: ['./upgrade-print-receipt.component.scss'],
    imports: [NgStyle, MatDialogTitle, MatDialogContent, MatDialogActions, MatButtonModule, DatePipe, TranslateModule]
})
export class UpgradePrintReceiptComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<UpgradePrintReceiptComponent>,
    @Inject(MAT_DIALOG_DATA) public data: IMembershipUpgrade, private memberService: MemberService, private translate: TranslateService) { }
