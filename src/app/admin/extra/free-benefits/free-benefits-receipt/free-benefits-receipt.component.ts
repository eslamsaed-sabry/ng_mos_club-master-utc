...
import { IFreeBenefit } from 'src/app/models/extra.model';
import { MatButtonModule } from '@angular/material/button';
import { NgStyle, DatePipe } from '@angular/common';
import { BrandService } from 'src/app/services/brand.service';
@Component({
    selector: 'app-free-benefits-receipt',
    templateUrl: './free-benefits-receipt.component.html',
    styleUrls: ['./free-benefits-receipt.component.scss'],
    imports: [NgStyle, MatDialogTitle, MatDialogContent, MatDialogActions, MatButtonModule, DatePipe, TranslateModule]
})
export class FreeBenefitsReceiptComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<FreeBenefitsReceiptComponent>,
    @Inject(MAT_DIALOG_DATA) public data: IFreeBenefit, private memberService: MemberService, private translate: TranslateService) { }
