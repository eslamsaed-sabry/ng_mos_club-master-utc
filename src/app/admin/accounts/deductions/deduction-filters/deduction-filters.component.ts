...
@Component({
    selector: 'app-deduction-filters',
    templateUrl: './deduction-filters.component.html',
    styleUrl: './deduction-filters.component.scss',
...
export class DeductionFiltersComponent {
