...
@Component({
    selector: 'app-employee-commission-filters',
    templateUrl: './employee-commission-filters.component.html',
    styleUrl: './employee-commission-filters.component.scss',
...
export class EmployeeCommissionFiltersComponent {
